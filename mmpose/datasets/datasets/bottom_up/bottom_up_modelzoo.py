...
class BottomUpModelZooDataset(BottomUpCocoDataset):
    ...
    def __init__(self,
        ...
        self.ann_info['flip_index'] = range(20)
        ...
        self.ann_info['joint_weights'] = np.ones(20)
        ...
        #    1.79, .72, .62
        #]) / 10.0
        self.sigmas = np.array([0.026 ,0.025 , 0.025 , 0.035,  0.035,  0.06,      0.06 ,     0.06,      0.062,
                                0.062,  0.072 , 0.072 , 0.079 , 0.079 , 0.062 , 0.062, 0.087,  0.087,
                                0.107 , 0.107])
