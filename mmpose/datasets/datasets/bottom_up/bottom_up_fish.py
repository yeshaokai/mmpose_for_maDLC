...
class BottomUpFishDataset(BottomUpCocoDataset):
    ...
    def __init__(self,
        ...
        self.ann_info['flip_index'] = range(10)
        ...
        self.ann_info['joint_weights'] = np.ones(10)
        
        # Adapted from COCO dataset
        self.sigmas = np.ones(10)*0.1
